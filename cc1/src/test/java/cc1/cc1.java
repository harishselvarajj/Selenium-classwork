...
public class cc1 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("JANANI");
			driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("C R");
			driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("623707");
